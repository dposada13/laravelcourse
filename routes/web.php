...
Route::get('/fish', 'App\Http\Controllers\FishController@index')->name('fish.index');
Route::get('/create', 'App\Http\Controllers\FishController@create')->name('fish.create');
Route::post('/save', 'App\Http\Controllers\FishController@save')->name('fish.save');
Route::get('/fish/{id}', 'App\Http\Controllers\FishController@show')->name('fish.show');
Route::get('/statistics', 'App\Http\Controllers\FishController@statistics')->name('fish.statistics');
